...
const promptExamples = [
  ["01", "전 세계 마트 필수템", "일본, 돈키호테, 5만 원 예산", "일본 돈키호테 쇼핑을 도와줘. 5만 원 안에서 선물용 추천 TOP5를 가격·이유·현지어 표현 표로 정리하고, 가격·재고는 공식 확인 필요라고 써 줘."],
  ["02", "날씨 맞춤 코디", "여수, 24도/15도, 데이트룩", "여수 24/15도 데이트 코디를 짜 줘. 상의·하의·아우터·신발 색과 소재, 일교차 준비물, 비 올 때 대안을 초보자용으로 알려 줘."],
  ["03", "자취생 트러블슈팅", "흰 셔츠에 김치 국물", "흰 셔츠 김치국물 대처법을 알려 줘. 주방세제·식초·베이킹소다만 써서 3단계로 설명하고, 문지르면 안 되는 이유와 금지 행동을 경고해 줘."],
  ["04", "오늘 뭐 보지?", "기묘한 이야기, 짧은 스릴러", "‘기묘한 이야기’를 좋아하고 짧은 스릴러를 찾고 있어. 넷플릭스 추천 3편을 장르·길이·맞는 이유·잔인함 정도로 정리하고 제공 여부는 확인 필요로 표시해 줘."],
  ["05", "갈등 사과문", "F 성향 친구에게 사과", "내 실수로 친구가 서운해했어. MBTI를 단정하지 말고 공감형 카톡 첫 문장 3개, 사과문 1개, 피할 말을 써 줘. 변명은 빼고 상황에 맞게 바꿀 곳을 표시해 줘."],
  ["06", "정중한 업무 거절", "자료 요청을 모레까지", "오늘 요청받은 자료를 모레 줄 수 있어. 관계를 지키는 메일 제목·본문·대안 일정과 메신저용 짧은 버전을 써 줘. 부드럽지만 확정 가능한 날짜는 분명히 밝혀 줘."],
  ["07", "3줄 요약", "기사·보고서 붙여넣기", "아래 글을 원문 밖의 사실 없이 핵심 3줄과 결론 1줄로 줄여 줘. 숫자·이름·조건은 보존하고 어려운 말은 괄호로 풀이해 줘.\n[본문 붙여넣기]"],
  ["08", "즉석 동화", "토끼 토토, 우주 공룡 마을", "토끼 토토가 우주 공룡 마을에서 ‘나누어 먹기’를 배우는 3분 동화를 써 줘. 무서운 장면은 빼고 부드러운 말투로 작성한 뒤 부모 질문 2개를 덧붙여 줘."],
  ["09", "집에서 20분 운동", "30대 직장인, 하체", "집에서 20분 하체 운동을 짜 줘. 층간소음 적은 맨몸 동작의 준비·세트·횟수·휴식을 시간표로 쓰고, 무릎 통증 시 중단할 안전 안내를 넣어 줘."],
  ["10", "쇼츠·릴스 제목", "강아지가 고양이 흉내", "강아지가 고양이 흉내 내는 영상 제목 5개를 호기심·유머·감성·정보·3초형으로 하나씩 써 줘. 과장·오해 표현은 검토해 안전한 대안으로 바꿔 줘."],
];
