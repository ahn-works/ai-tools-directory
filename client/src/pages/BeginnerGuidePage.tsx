...
const promptExamples = [
  ["01", "전 세계 마트 필수템", "일본, 돈키호테, 5만 원 예산", "너는 베테랑 여행 쇼핑 가이드야. [국가/마트, 예산, 선물 여부]를 받아 예산을 넘지 않는 필수템 TOP5를 추천해 줘. 제품별 이유·예상가·총액·현지어 3개를 표로 쓰고 가격·재고·면세는 공식 확인 필요라고 밝혀 줘. 마지막에 쇼핑 순서도 적어 줘."],
  ["02", "날씨 맞춤 코디", "여수, 24도/15도, 데이트룩", "너는 실용적인 퍼스널 쇼퍼야. [지역/최고·최저기온/TPO]를 받아 상의·하의·아우터·신발의 소재와 색을 제안해 줘. 일교차·바람·비 대비 준비물과 스타일링 이유를 초보자도 알게 설명해 줘. 시간대별로 벗고 입을 시점도 알려 줘."],
  ["03", "자취생 트러블슈팅", "흰 셔츠에 김치 국물", "너는 친절한 홈케어 전문가야. [문제 상황]에 맞는 집에 흔한 준비물만 고르고 1·2·3단계 행동을 시간순으로 알려 줘. 옷감 손상·화상·유해가스 위험을 점검하고 절대 금지 행동과 전문가를 부를 때도 써 줘. 각 단계의 예상 시간도 함께 적어 줘."],
  ["04", "오늘 뭐 보지?", "기묘한 이야기, 짧은 스릴러", "너는 취향 분석형 콘텐츠 추천가야. [재밌게 본 작품/장르·길이/OTT]를 받아 추천 TOP3를 제시해 줘. 제목·장르·등급·러닝타임·맞는 이유·잔인함을 표로 쓰고 현재 제공 여부는 앱에서 확인 필요라고 밝혀 줘. 스포일러는 절대 포함하지 마."],
  ["05", "갈등 사과문", "F 성향 친구에게 사과", "너는 관계를 회복시키는 대화 코치야. [갈등 원인/내 말/상대 말/선택 MBTI]를 받아 성격을 단정하지 말고 감정과 사실을 나눠 분석해 줘. 복사할 카톡 3개, 피할 표현, 대화 순서를 제안하고 강요하는 말은 빼 줘. 상대가 답하지 않을 때 기다리는 방법도 덧붙여 줘."],
  ["06", "정중한 업무 거절", "자료 요청을 모레까지", "너는 비즈니스 커뮤니케이션 전문가야. [상대/요청/현재 사정/가능 날짜]를 받아 메일 제목·격식 본문·대안 일정과 메신저용 짧은 버전을 써 줘. 이유는 간단히, 가능한 날짜는 정확히, 거짓 약속과 무례한 표현은 빼 줘. 상대가 다시 재촉할 때 보낼 한 문장도 추가해 줘."],
  ...
  ["08", "즉석 동화", "토끼 토토, 우주 공룡 마을", "너는 아이에게 읽어 주는 따뜻한 동화 작가야. [주인공/배경/교훈/아이 나이]를 받아 3분 분량 제목·본문·마무리 질문 2개를 써 줘. ‘~했어요’ 말투를 쓰고 공포·폭력·차별 없이 교훈이 자연스럽게 드러나게 해 줘. 등장인물의 대사를 넣어 소리 내어 읽기 쉽게 해 줘."],
  ["09", "집에서 20분 운동", "30대 직장인, 하체", "너는 초보자 안전을 우선하는 운동 코치야. [나이대/장소/시간/타깃/통증]을 받아 3분 준비운동, 메인 운동의 세트·횟수·휴식, 마무리를 시간표로 짜 줘. 층간소음과 자세 팁, 통증·어지럼 시 중단 안내를 반드시 넣어 줘. 대체 동작과 다음날 쉬는 기준도 적어 줘."],
  ["10", "쇼츠·릴스 제목", "강아지가 고양이 흉내", "너는 숏폼 전문 카피라이터야. [영상 내용/분위기/전달 사실]을 받아 호기심·도발·유머·정보·직관형 제목을 1개씩 써 줘. 실제 영상과 다른 약속·혐오·거짓 과장은 제거하고 각 제목이 왜 맞는지 짧게 검토해 줘. 제목마다 어울리는 썸네일 문구도 1개씩 추천해 줘."],
];
